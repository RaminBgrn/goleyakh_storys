...
class _WidgetRadioGroupState extends State<WidgetRadioGroup> {
  ...
  void initState() {
    ...
    buttonState = List<bool>.generate(
      widget.data.length,
      (index) {
        return (previousActiveButton >= 0 && index == previousActiveButton) ? true : false;
      },
    );
    super.initState();
  }
          ...
          return MouseRegion(
            ...
            child: Tooltip(
              ...
              child: GestureDetector(
                ...
                child: Row(textDirection: widget.radioIconAndTextDirection, mainAxisSize: MainAxisSize.min, children: [
                  Text(
                    widget.title ?? '',
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: buttonState[index] ? widget.activeShadow : widget.deactivateShadow,
                      ),
                      child: box(widget.iconTye, widget.data[index], buttonState[index]))
                ]),
              ),
            ),
          );
  ...
  Widget iconSvgAsset(String path, bool isActive) {
    return SvgPicture.asset(
      ...
      colorFilter: isActive
          ? ColorFilter.mode(widget.activeIconColor ?? Colors.transparent, BlendMode.srcIn)
          : ColorFilter.mode(widget.deactivateIconColor ?? Colors.transparent, BlendMode.srcIn),
    );
  }
